...
public class TrainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //setup session list
        Button btn_add_session = findViewById(R.id.button_session_list_add);
        ...
        final EditText textModelPath = findViewById(R.id.model_filepath);
        textModelPath.setText(FileCons.MODELS_DIR);

        ImageButton butModelPath = findViewById(R.id.model_filepath_button);
        ...
        Button butTrain = findViewById(R.id.train_button);
    ...
    private void trainModel() {
        ...
        for (int i = 0; i < sessions.size(); i++) {
            ...
            CheckBox checkBox = findViewById(R.id.train_anno_garbage);
